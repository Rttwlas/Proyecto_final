...
from AppBazar.models import Bazar, PedidoPorEncargue
...
def Pedidos(request):
      if request.method == 'POST':
            ...
            if miFormulario.is_valid:
                  ...
                  Pedido = PedidoPorEncargue(producto=informacion['producto'], cantidad=informacion['cantidad'] , mail=informacion['mail'])              
                  Pedido.save()
